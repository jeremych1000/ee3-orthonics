...
<meta property="og:title" content="Orthonics Auto-Email"></meta>
<title>Orthonics Auto-Email</title>
</head>
<!--[if mso]>
  <body class="mso">
<![endif]-->
    ...
    <div class="wrapper" style="min-width: 320px;background-color: #ededf1;" lang="x-wrapper">
      <div class="preheader" style="Margin: 0 auto;max-width: 560px;min-width: 280px; width: 280px;width: calc(28000% - 173040px);">
        ...
        <!--[if (mso)|(IE)]><table align="center" class="preheader" cellpadding="0" cellspacing="0"><tr><td style="width: 280px" valign="top"><![endif]-->
          <div class="snippet" style="Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 140px; width: 140px;width: calc(14000% - 78120px);padding: 10px 0 5px 0;color: #7c7e7f;font-family: Ubuntu,sans-serif;">
            <!-- <p style="Margin-top: 0;Margin-bottom: 0;">Please do not reply.</p> -->
          </div>
      ...
      <!--[if (mso)|(IE)]><table align="center" class="header" cellpadding="0" cellspacing="0"><tr><td style="width: 600px"><![endif]-->
        <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
          <div class="logo-center" style="font-size:0px !important;line-height:0 !important;" align="center" id="emb-email-header"><img style="height: auto;width: 100%;border: 0;max-width: 149px;" src="resources/laser_wikipedia.png" alt="" width="149"></div>
        </div>
      <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
      </div>
      ...
      <h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #788991;font-size: 16px;line-height: 24px;text-align: center;">&nbsp;</h3><h1 style="Margin-top: 12px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #3e4751;font-size: 22px;line-height: 31px;font-family: Ubuntu,sans-serif;text-align: center;">New Laser Attack Detected</h1><p style="Margin-top: 20px;Margin-bottom: 20px;"><span>Hi, we are the team at Orthonics and our devices have detected a laser attack on an aircraft in your&nbsp;vicinity. We have collected all the details and evidence you need to arrest the attacker. Please act <strong>fast </strong>as the attacker may move to a different location at any time.</span></p>
    </div>
      ...
      <div style="line-height:5px;font-size:1px">&nbsp;</div>
            ...
            <div style="Margin-left: 20px;Margin-right: 20px;">
      <h2 class="size-16" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #3e4751;font-size: 16px;line-height: 24px;font-family: Ubuntu,sans-serif;" lang="x-size-16"><strong>What does this mean for me?</strong></h2><p style="Margin-top: 16px;Margin-bottom: 20px;">By clicking the link below, you will be taken to a PDF report of the attacker. This report contains the flight details, the attacker's location (as estimated by Google), and the evidence image showing the attack.</p>
    </div>
...
$f_id = @$_GET['flight_id'];
$i_id = @$_GET['image_id'];
$url = 'http://orthonics.zapto.org/create_report.php?flight_id='.$f_id.'&image_id='.$i_id;
...
?>
      ...
      <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
        <![if !mso]><a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #fff;background-color: #4eaacc;font-family: 'PT Serif', Georgia, serif;" href="<?php echo $url; ?>">READ THE REPORT</a><![endif]>
      <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="<?php echo $url; ?>" style="width:178px" arcsize="9%" fillcolor="#4EAACC" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,11px"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Georgia,serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">READ THE REPORT</center></v:textbox></v:roundrect><![endif]--></div>
    </div>
...
Orthonics</p>
        ...
        <div style="font-size: 12px;font-style: normal;font-weight: normal;" align="left">
          <img style="border: 0;display: block;height: auto;width: 100%;max-width: 160px;" src="resources/sig.png" alt="" width="160">
        </div>
      </div>
      ...
      <div class="layout two-col has-gutter" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 173000px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
        <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0"><tr><td style="width: 290px" valign="top" class="w250"><![endif]-->
          <div class="column" style="Float: left;max-width: 320px;min-width: 290px; width: 320px;width: calc(18290px - 3000%);">
            <table class="column__background" style="border-collapse: collapse;table-layout: fixed;background-color: #ffffff;" cellpadding="0" cellspacing="0" width="100%" emb-background-style>
              <tbody><tr>
                <td style='text-align: left;color: #7c7e7f;font-size: 14px;line-height: 21px;font-family: "PT Serif",Georgia,serif;'>
                
                  <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;Margin-bottom: 24px;">
      <h2 class="size-16" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #3e4751;font-size: 16px;line-height: 24px;font-family: Ubuntu,sans-serif;" lang="x-size-16"><strong>Frequently Asked Questions</strong></h2><ul style="Margin-top: 16px;Margin-bottom: 0;Margin-left: 24px;padding: 0;list-style-type: disc;">
      <li style="Margin-top: 16px;Margin-bottom: 0;Margin-left: 0;"><a href="https://www.google.co.uk/#q=pros+cons+brexit">Should the UK leave the European Onion?</a></li>
      <li style="Margin-top: 0;Margin-bottom: 0;Margin-left: 0;"><a href="http://withimagination.imgtec.com/wp-content/uploads/2013/03/Imagination-and-Imperial-College-London-7.jpg">Why is the 5th floor lab full of 2nd years?</a></li>
      <li style="Margin-top: 0;Margin-bottom: 0;Margin-left: 0;"><a href="http://www.grandpainmypocket.co.uk/images/Paradise%20Pineapple%20Pizza.jpg">Is pineapple a real pizza topping?</a></li>
      <li style="Margin-top: 0;Margin-bottom: 0;Margin-left: 0;"><a href="#" onClick="alert('Got you!')">Where can I buy striped paint?</a></li>
      <li style="Margin-top: 0;Margin-bottom: 0;Margin-left: 0;"><a href="http://www.londonlovesbusiness.com/pictures/462xAny/5/1/9/20519_1.jpg">Can tube drivers please stop striking?</a></li>
      </ul>
    </div>
            ...
            <table class="column__background" style="border-collapse: collapse;table-layout: fixed;background-color: #ffffff;" cellpadding="0" cellspacing="0" width="100%" emb-background-style>
              <tbody><tr>
                <td style='text-align: left;color: #7c7e7f;font-size: 14px;line-height: 21px;font-family: "PT Serif",Georgia,serif;'>
                  ...
                  <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;Margin-bottom: 24px;">
      <h2 class="size-16" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #3e4751;font-size: 16px;line-height: 24px;font-family: Ubuntu,sans-serif;" lang="x-size-16"><strong>Contact</strong></h2><p style="Margin-top: 16px;Margin-bottom: 0;"><strong>General inquiries:</strong><br>
+44 7503379106</p><p style="Margin-top: 20px;Margin-bottom: 0;"><strong>Calling from overseas:</strong><br>
<span>+44 7503379106</span></p><p style="Margin-top: 20px;Margin-bottom: 0;"><strong>Email inquiries:</strong><br>
<span><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #4eaacc;" href="mailto:jc4913@ic.ac.uk">jc4913@ic.ac.uk</a></span></p>
    </div>
        ...
        <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0"><tr class="layout-email-footer"><td style="width: 400px;" valign="top" class="w360"><![endif]-->
          <div class="column wide" style="text-align: left;font-size: 12px;line-height: 19px;color: #7c7e7f;font-family: Ubuntu,sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
              ...
              <div>
                <div><a href="http://orthonics.zapto.org/">Powered by googling StackOverflow.</a></div>
              </div>
              <div style="Margin-top: 18px;">
                <div>You are receiving this email as you are the listed police authority for this area. Please contact Orthonics before unsubscribing, as you will lose access to these real-time police reports.</div>
              </div>
            </div>
          </div>
      ...
      <div class="layout one-col email-footer" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 173000px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
        ...
        <!--[if (mso)|(IE)]><table align="center" cellpadding="0" cellspacing="0"><tr class="layout-email-footer"><td style="width: 600px;" class="w560"><![endif]-->
          <div class="column" style="text-align: left;font-size: 12px;line-height: 19px;color: #7c7e7f;font-family: Ubuntu,sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
              <div>
                <span><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #7c7e7f;" href="http://orthonics.zapto.org/show_text.php?text=placeholder" lang="en">Preferences</a>&nbsp;&nbsp;|&nbsp;&nbsp;</span><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #7c7e7f;" href="http://orthonics.zapto.org/show_text.php?text=placeholder">Unsubscribe</a>
              </div>
            </div>
          </div>
        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
  ...
  </div><img style="overflow: hidden;position: fixed;visibility: hidden !important;display: block !important;height: 1px !important;width: 1px !important;border: 0 !important;margin: 0 !important;padding: 0 !important;" src="" width="1" height="1" border="0" alt="">
</body></html>
